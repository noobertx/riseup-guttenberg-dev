            ...
            <Fragment>
                ...
                <div className={`wprig-block-${uniqueId}${className ? ` ${className}` : ''}`}>
                    <div
                        ...
                        className={`wprig-block-social-icons wprig-layout-${layout} wprig-style-${useDefaultStyle ? 'default' : 'custom'}`} >
                        ...
                        <ul className="wprig-ul" >
                            {socialIcons.map((item, index) =>
                                <li key={index} className={`wprig-li wprig-social-item wprig-social-${item.id}`} arealabel={item.label} >
                                    ...
                                    >
                                        ...
                                        {(iconLabel && item.label) && <div className="wprig-social-label" contenteditable="true" onBlur={(e) => this.setSettings(selectedLabel, 'label', e.target.innerHTML)}>{item.label}</div>}
                                    </a>
                                    ...
                                    {(showIconPicker && selectedItem == index && isSelected) &&
                                        <Fragment>
                                            <Popover
                                                ...
                                                className="wprig-socialicon-picker-popover"
                                            >
                                                <div className="wprig-socialicon-picker">
                                                    ...
                                                    <Button
                                                        ...
                                                        isLarge
                                                        isPrimary
                                                        className="wprig-action-social-icon-apply"
                                                    ...
                                                    <Button
                                                        isDefault
                                                        isLarge
                                                        className="wprig-action-social-icon-remove"
                            ...
                            <span onClick={() => this.insertItem()} className="wprig-social-icon-insert" role="button" arealabel={__('Add new icon')}>
                                <i className="wprig-social-icon fas fa-plus" />
                            </span>
                        </ul>
