        ...
        return (
            <Fragment>
                 ...
                 */}
                    {/* <div className={this.getClassName()}> */}
                        {/* <div className={`wprig-row wprig-backend-row ${(heightOptions == 'window') ? 'wprig-row-height-window' : ''}`}> */}
                            <InnerBlocks template={this.getTemplate(elRow,elColumn)} templateLock="all" allowedBlocks={['wprig/grid-blocks-cell']} />
                        </div>
                    {/* </div> */}
