...
class Edit extends Component {
    ...
    render() {
        ...
        const actionButtons = (id, attr) => {
            return (
                <div className="wprig-media-actions">
                    <MediaUpload
                        value={id}
                    ...
                    <Tooltip text={__('Remove')}>
                        <button className="wprig-button" aria-label={__('Remove')} onClick={() => setAttributes({ [attr]: {} })} role="button">
                        ...
                        )}>
                            {
                                validImageB ?
                                    <div className={'image-container-inner'}>
                                        <img className="wprig-image" src={image2.url} {...(image2_2x.url ? { srcset: image2.url + ' 1x, ' + image2_2x.url + ' 2x' } : {})} alt={imgAlt2 && imgAlt2} />
                                        {
                                            disableTitle && (
                                                <RichText
                                                    value={imageBTitle}
                        ...
                        <div className={classnames(
                        ...
                        )}>
                            {
                                validImageA ?
                                    <div className={'image-container-inner'}>
                                        {
                                            <img className="wprig-image" src={image.url} {...(image2x.url ? { srcset: image.url + ' 1x, ' + image2x.url + ' 2x' } : {})} alt={imgAlt && imgAlt} />
                                        }
                                        {
                                            disableTitle && (
                                                <RichText
