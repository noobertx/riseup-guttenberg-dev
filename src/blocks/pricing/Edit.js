...
class Edit extends Component {
		...
		return (
			<span className="wprig-pricing-duration">
				<RichText
					...
					className="wprig-product-duration"
	...
	renderPricingButton = () => {
		...
		return (
			<div className={`wprig-pricing-button`} onClick={() => this.handlePanelOpenings('Button')}>
				<wprigButtonEdit
					...
					onTextChange={val => setAttributes({ buttonText: val })} />
				{
					...
					<div className="wprig-pricing-postbutton-text">
						<RichText
							...
							className="wprig-pricing-post-button-text"
	...
	renderPricingTitle = () => {
		...
		return (
			<Fragment>
				<span className="wprig-pricing-title-wrapper" onClick={() => this.handlePanelOpenings('Title')}>
					<RichText
						value={title}
						key="editable"
						keepPlaceholderOnFocus
						placeholder={__('Add Title...')}
						className="wprig-pricing-title"
	...
	renderPricingSubTitle = () => {
		...
		return (
			<div className="wprig-sub-title-wrapper" onClick={() => this.handlePanelOpenings('Sub Title')}>
				<RichText
					value={subTitle}
					key="editable"
					keepPlaceholderOnFocus
					placeholder={__('Add Product Teaser...')}
					className="wprig-sub-title"
	...
	renderPricingPrice = () => {
		...
		return (
			<div className="wprig-pricing-wrapper" onClick={() => this.handlePanelOpenings('Price')}>
				{currencyPosition == 'before' && this.renderCurrencyContent()}
				<span className="wprig-pricing-price" contenteditable="true" onBlur={(e) => setAttributes({ price: e.target.innerText })}>
		...
		return (
			<Fragment>
				...
				<div className={`wprig-block-${uniqueId}${className ? ` ${className}` : ''}`} >
					<div
						className={`wprig-block-pricing`}
						onContextMenu={event => handleContextMenu(event, this.wprigContextMenu.current)}
					>
						{enableBadge && <span className={`wprig-pricing-badge wprig-badge-style-${badgeStyle} wprig-badge-size-${badgeSize}`} contenteditable="true" onBlur={(e) => setAttributes({ 'badge': e.target.innerText })} onClick={() => this.handlePanelOpenings('Badge')}><span>{badge}</span></span>}
						<div className="wprig-block-pricing-content">
							...
							{enableFeatures &&
								<div ref={this.contextRef} className={`wprig-pricing-features`} onClick={() => this.handlePanelOpenings('Features')}>
									<wprigIconListEdit
										parentBlock={`wprig-block-${uniqueId}`}
