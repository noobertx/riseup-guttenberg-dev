...
class Edit extends Component {
    ...
    getColumnWidth(){
        ...
        return `col-lg-${columnWidth.md} col-md-${columnWidth.sm} col-${columnWidth.xs}`;
    }
            ...
            <Fragment>
                    ...
                    <InspectorTabs tabs={['style', 'advance']}>
                        <InspectorTab key={'style'}>
                            <PanelBody initialOpen={true} title={__('Dimension')}>
                                ...
                                <div className="wprig-mb-20">
                                    <Range label={__('Width')} value={columnWidth} onChange={val => setAttributes({ columnWidth: val }) } min={1} max={12} responsive device={this.state.responsiveDevice} />
                                </div>
                            </PanelBody>
                ...
                {rowWidth !== 0 &&
                    <ResizableBox
                        ...
                        <div className={`wprig-column ${this.getColumnWidth()} wprig-column-admin wprig-block-${uniqueId}${className ? ` ${className}` : ''}`} data-column-width={this.props.attributes.colWidth.md}>
