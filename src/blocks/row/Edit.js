            ...
            <Fragment>
                            ...
                            <PanelBody initialOpen={true} title={__('Dimension')}>
                                ...
                                <div className="wprig-field">
                                    ...
                                    <div className="wprig-field-button-list wprig-field-button-list-fluid">
                                        <Tooltip text={__('Top')}>
                                            <button
                                                onClick={() => setAttributes({ position: 'align-items-start' })}
                                                className={"wprig-button" + (position === 'align-items-start' ? ' active' : '')}
                                            >{icons.vertical_top}</button>
                                        </Tooltip>

                                        <Tooltip text={__('Middle')} >
                                            <button
                                                onClick={() => setAttributes({ position: 'align-items-center' })}
                                                className={"wprig-button" + (position === 'align-items-center' ? ' active' : '')}
                                            >{icons.vertical_middle}</button>
                                        </Tooltip>

                                        <Tooltip text={__('Bottom')} >
                                            <button
                                                onClick={() => setAttributes({ position: 'align-items-end' })}
                                                className={"wprig-button" + (position === 'align-items-end' ? ' active' : '')}
                ...
                <div className={`wprig-section wprig-block-${uniqueId} ${(rowBg.bgimgParallax && rowBg.bgimgParallax == 'animated') ? 'wprig-section-parallax' : ''}${className ? ` ${className}` : ''}`} {...rowId ? { id: rowId } : ''}>
                    ...
                    <div className={this.getClassName() }>
                        <div className={`wprig-row wprig-backend-row ${position} ${(heightOptions == 'window') ? 'wprig-row-height-window' : ''}`}>
