            ...
            return (
                <li className="yani-list-li yani-list-li-editor" >
                    <div ref="avoidOnClick" className={`yani-list-item yani-list-item-${index}`} onClick={() => this.setState({ currentListItemIndex: index })}>
                        {iconPosition == 'left' && <span className={`yani-list-item-icon ${item.icon} fa-fw`} onClick={() => this.setState({ openIconPopUp: openIconPopUp ? (currentListItemIndex == index) ? false : true : true })} />}
                        <div
                            className={`yani-list-item-text-${index}`}
                        ...
                        {iconPosition == 'right' && <span className={`yani-list-item-icon ${item.icon} fa-fw`} onClick={() => this.setState({ openIconPopUp: openIconPopUp ? (currentListItemIndex == index) ? false : true : true })} />}
                        {
                            item.text.length > 0 &&
        ...
        return (
            <Fragment>
                                ...
                                />
                                 <SelectControl
                                            ...
                                            options={[
                                                ...
                                                { label: 'Horizontal', value: 'style-2' },
                                            ]}
                ...
                <div className={`yani-block-${uniqueId}${className ? ` ${className}` : ''}`}>
                    ...
                    >
                        <ul className={`editor yani-list yani-icon-list-connector ${style}`}>
