    ...
    componentDidMount() {
      ...
      return new Promise((resolve, reject) => {
        ...
        loadImg.onerror = err => reject(err)
            ...
            setTimeout(function(){
                jQuery("#gallery").Mosaic({maxRowHeight:400});
            },500)
                            ...
                            <div className="overlay">
                                <div className="overlay-content">
                                   <div className={`overlay-content ${overlayParams.overlayLayout}`}>
                                    ...
                                    {overlayParams.enableLinkButton &&

                                        <button type="button" className="link">
                                             <i className={`wprig-btn-icon ${overlayParams.linkIconName}`}></i>
                                            {
                                            overlayParams.linkButtonLabel
                                        }</button>
                                    }
                                    </div>
                                </div>
    ...
    render() {
        ...
        return(
            ...
            <Fragment>
                ...
                <ResponsiveMasonry columnsCountBreakPoints={{350: columns.xs, 750: columns.sm, 900: columns.md}}  >
