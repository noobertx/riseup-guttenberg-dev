    ...
    componentDidMount() {
        ...
        const getAllChildHeadingBlocks = parentBlock => {
            ...
            parentBlock.innerBlocks.forEach(childBlock => {
                if (childBlock.name === 'core/heading' || childBlock.name === 'wprig/heading' || childBlock.name === 'wprig/text') {
        ...
        const getsHeadingBlocks = () => {
            ...
            allBlocks.forEach(block => {
                if (block.name === 'core/heading' || block.name === 'wprig/heading' || block.name === 'wprig/text') {
