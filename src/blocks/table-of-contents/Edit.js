                ...
                <BlockControls>
                    ...
                    <Toolbar controls={
                        [{
                            ...
                            className: `wprig-action-change-listype ${tableType == 'unordered' ? 'is-active' : ''}`,
                        }, {
                            icon: 'editor-ol',
                            title: 'Convert to ordered list',
                            onClick: () => setAttributes({ tableType: 'ordered' }),
                            className: `wprig-action-change-listype ${tableType == 'ordered' ? 'is-active' : ''}`,
                        }]}
                    />
                </BlockControls>
                    ...
                    <InspectorTabs tabs={['style', 'advance']}>
                        ...
                        /> */}
                                <div className="wprig-field ">
                                    ...
                                    <div className="wprig-toc-allowed-headings">
                                        <CheckboxControl
                                            label={__('H1')}
                                    ...
                                    minimizeBox && (
                                        <Fragment>
                                            ...
                                            <RadioAdvanced
                                                label={__('Alignment')}
                                                options={[
                                                    { icon: 'fas fa-align-justify', value: 'wprig-justify-between', title: __('Justify') },
                                                    { icon: 'fas fa-align-left', value: 'wprig-justify-start', title: __('Start') },
                                                    { icon: 'fas fa-align-center', value: 'wprig-justify-center', title: __('Center') },
                                                    { icon: 'fas fa-align-right', value: 'wprig-justify-end', title: __('End') }
                                                ]}
                ...
                <div className={classes}>
                    ...
                    >
                        <div className={classnames([
                            ...
                            {
                                showTitle && (
                                    <div class="wprig-table-of-contents-heading">
                                        <RichText
                                            tagName="div"
                                            value={title}
                                            className="title"
                            ...
                            }
                            {
                                minimizeBox && (
                                    <div
                                        className='wprig-table-of-contents-toggle'
