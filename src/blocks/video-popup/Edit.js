        ...
        return (
            <Fragment>
                ...
                <div className={`wprig-block-${uniqueId}${className ? ` ${className}` : ''}`}>
                    <div
                        className={`wprig-block-videopopup-wrapper wprig-alignment-${alignment}`}
                    ...
                    >
                        ...
                        <div className={`wprig-block-videopopup wprig-size-${iconSize}`} >
                            <a className="wprig-video-popup" ref={el => this.el = el} href={videoSource == 'external' ? url : (bgVideo.url || '')}>
                                {prefix && <span className="wprig-video-popup-prefix"> {prefix} </span>}
                                {icon &&
                                    <span className="wprig-btn-icon-wrapper">
                                        <i className={`wprig-btn-icon ${icon}`}>
                                            {(iconBgColor && isRipple) && <span className="wprig-ripple" />}
                                        </i>
                                    </span>
                                }
