    ...
    render() {
        ...
        return (
            <Fragment>
                    ...
                    <InspectorTabs defaultTab={'style'}>
                        <InspectorTab key={'layout'}>
                            <PanelBody title={__('Design Templates')}>
                                <img src={wprig_admin.plugin + 'assets/img/blocks/pieprogress/template-pro-notice.jpg'} alt={__('Pie Porgress Templates')} />
                            </PanelBody>
                        </InspectorTab>
                ...
                <div
                    className={`wprig-block-${uniqueId} wprig-block-pie-progress${className ? ` ${className}` : ''}`}
