    ...
    constructor(props) {
        ...
        this.state = {
            ...
            breakingPoints: {
                ...
                lg: 960,
                xl: 1140,
                ...(typeof rsup_container_width !== undefined && rsup_container_width)
            }
        }
        this.ref = createRef();
    ...
    render() {
        ...
        const updateBreakingPoints = (key, newValue) => {
            this.setState(({ presets, activePreset, breakingPoints }) => {
                ...
                if (typeof rsup_container_width !== undefined) {
                    defaultValue = rsup_container_width[key]
                } else {
                    if (key === 'sm') {
                        defaultValue = 720;
                    } else if (key === 'md') {
        ...
        return (
            ...
            <Fragment>
                ...
                <Button
                            ...
                            title={__('Display Full')}
                            onClick={()=>{
                                console.log("Displaying Full")
                                if(document.body.classList.contains('yani-editor-expand')){
                                    document.body.classList.remove('yani-editor-expand');
                                }else{
                                    document.body.classList.add('yani-editor-expand');                            
                                }
                            }}
                        >Full View
                        </Button>
